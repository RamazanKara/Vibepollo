...
namespace amf {
  ...
  public:
    /**
     * @brief Construct an AMF encoder around an existing D3D11 device.
     *
     * @param d3d_device D3D11 device used for conversion and AMF input.
     */
  ...
  private:
    /**
     * @brief Resolve the AMF runtime and required factory functions.
     *
